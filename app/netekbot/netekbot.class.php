      ...
      switch ($phase) {
        ...
        case 0:
          ...
          if ($serviceProvider === 'not_found') {
            ...
            $message->setMessage('על מנת לנתק אותך מ'.$message->getMessage().' אצטרך ממך מספר פרטים.\n\nחשוב לי לציין שהפרטיות שלך חשובה לי מאוד ולכן אני מתחייב לא לשמור ולא לשתף את הפרטים המזהים שלך עם אף גורם צד ג.');
          }
      }
